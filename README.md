...
| `build` | `./gradlew build` в каталоге `gradle` | Gradle-плагин, линтер и `coderpack-0.100.2.zip` с командной утилитой |
...
| `idea` | `./gradlew buildPlugin` | `build/distributions/sacred-idea-0.100.2.zip`. При выпуске CI также отправляет плагин в JetBrains Marketplace |
