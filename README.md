...
Проект начался с вопроса, который не отпускал автора с детства: можно ли спустя
...
| `idea` | Плагин для IntelliJ IDEA с мастером нового проекта, конфигурацией запуска Sacred, значками на полях и настройкой папки игры. |
...
Автор играл в Path of Exile, Path of Exile 2, Last Epoch и Titan Quest — это
